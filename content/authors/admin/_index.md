...
highlight_name: true
interests:
- Bayesian Networks, Graphical Models & Hierarchical Modeling
- Public Health & Qatar Biobank Research
- Biostatistics for Hematology, Oncology & Clinical Research
...
- Systematic Reviews & Bayesian/Frequentist Meta-Analysis
...
Dr. Malouche’s research spans a broad range of statistical and interdisciplinary domains. His methodological work centres on Bayesian networks and graphical models, Bayesian hierarchical modeling for evidence synthesis when only a few studies are available, epidemiological modeling, and reproducible data science workflows in R and Stan. As the statistician on interdisciplinary teams, he works extensively with Qatar Biobank data, leading and co-authoring studies on chronic pain, cardiometabolic risk, autoimmune diseases, hematological abnormalities, and gender disparities in quality of life. His clinical collaborations, in which he designs the analyses and leads the statistical modeling, extend to oncology (pancreatic cancer, T-cell leukemia, diffuse large B-cell lymphoma), neurological disorders (multiple sclerosis), and systematic reviews and meta-analyses of clinical outcomes. Beyond biomedical research, he collaborates on engineering education and educational technology, examining the impact of virtual reality and blended learning on student engagement. He is also engaged in interdisciplinary work at the intersection of statistics, AI regulation, anticipatory law, and finance, applying quantitative foresight methods to emerging legal and economic challenges. His recent work further examines the reliability of AI-detection tools in scientific publishing.
